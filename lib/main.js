...
function parseFlake8Output(output, workingDirectory) {
...
function createCheck(check_name, title, annotations) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield octokit.checks.listForRef(Object.assign({ check_name }, github.context.repo, { ref: github.context.sha }));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const flake8Output = yield runFlake8(workingDirectory);
